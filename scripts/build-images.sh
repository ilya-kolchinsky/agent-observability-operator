...
build_image mock-mcp-server demo-apps/mock-mcp-server/Dockerfile
build_image mock-external-http-service demo-apps/mock-external-http-service/Dockerfile
