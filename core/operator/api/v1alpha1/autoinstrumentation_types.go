...
type InstrumentationSpec struct {
	...
	// Generated field - see operator/api/v1alpha1/autoinstrumentation_types_generated.go
...
//+kubebuilder:resource:path=autoinstrumentations,singular=autoinstrumentation,scope=Namespaced,shortName=ai
//+kubebuilder:printcolumn:name="Phase",type=string,JSONPath=`.status.phase`
//+kubebuilder:printcolumn:name="Target",type=string,JSONPath=`.status.targetWorkloadRef`
//+kubebuilder:printcolumn:name="Age",type=date,JSONPath=`.metadata.creationTimestamp`

// AutoInstrumentation is the Schema for the agent observability demo API.
